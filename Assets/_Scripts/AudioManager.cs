...
public class AudioManager : MonoBehaviour
{
    ...
    [SerializeField] Sound idleSound;
    [SerializeField] AnimationCurve EngineCurve;
    float EnginePitch = 0f;
    ...
    void Awake () 
    {
        ...
        SetMusicVolume("truck", 1f);
        GetSFXSource("run").loop = true;
        GetSFXSource("idle").loop = true;
    ...
    public void SetEnginePitch(float enginePitch)
    {
    ...
    void Update() {
        ...
        */
        //InputHandler.Instance.Acceleration * 
        GetSFXSource("run").pitch = EngineCurve.Evaluate(EnginePitch);
        //runSound.source.pitch = EngineCurve.Evaluate(carSpeed);
